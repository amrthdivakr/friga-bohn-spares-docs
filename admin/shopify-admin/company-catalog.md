...
![](../images/shopify-admin/company-catalog/step-01.jpeg)


2\. Click **Markets**

![](../images/shopify-admin/company-catalog/step-02.jpeg)


3\. Click **Catalogs**

![](../images/shopify-admin/company-catalog/step-03.jpeg)


4\. Click **Create catalog**

![](../images/shopify-admin/company-catalog/step-04.jpeg)


5\. Add the **Title**.

![](../images/shopify-admin/company-catalog/step-05.jpeg)


6\. Click this icon to change target to **Company locations**

![](../images/shopify-admin/company-catalog/step-06.jpeg)


7\. Click **Company locations**

![](../images/shopify-admin/company-catalog/step-07.jpeg)


8\. Click **Add a company location** and add all company locations that follows this catalog

![](../images/shopify-admin/company-catalog/step-08.jpeg)


9\. add to the **Overall adjustment** field for entered percentage discounts for all included parts

![](../images/shopify-admin/company-catalog/step-09.jpeg)


10\. For different pricing of products or groups of products, add adjusted prices for each part.

![](../images/shopify-admin/company-catalog/step-10.jpeg)


11\. Click this icon to search for parts.

![](../images/shopify-admin/company-catalog/step-11.jpeg)
